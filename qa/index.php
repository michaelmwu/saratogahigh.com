...
<html>
	...
	<body>
        ...
        if($group['QAGROUP_SHOWPRELIM'])
        	print '<h2 class="blueheading">Enter Preliminary Info</h2><div class="hcontent"><a href="specials/prelim.php?rg=' . $_GET['group'] . '">Check</a> to make sure that your personal information is up-to-date before you begin.</div>';
	...
	if($group['QAGROUP_SHOWCHECK'])
         print '<h2 class="blueheading">View Donation Summary</h2><div class="hcontent">Here\'s the <a href="specials/check.php?group=' . $_GET['group'] . '">list of organizations</a> you opted to donate to. Write checks and/or pay online!</div>';
        print '<h2 class="blueheading">Confirm Your Submission</h2><div class="hcontent">You only need to print, sign and mail or drop off <a href="specials/sigs.php?group=' . $_GET['group'] . '">this sheet</a>, and you\'re all set.</div>';
        ...
        <p style="margin: 0px; padding: 3px; background-color: #eeeeee; border-bottom: 1px solid #999999">This is a trial of a new service for administering quizzes and surveys. All data are submitted electronically; our software compiles the results and calculates scores and tallies. It saves time, energy, and paper! Please send us your suggestions using the gray comment box at the bottom of this page. If you're a teacher or a club head who would like to test out this service, please drop us a line (using the gray box).</p>
        <?
