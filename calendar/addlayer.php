...
?>
	...
	<? if($isteacher && false) { // Homework calendars disabled at request of administration. ?>
	...
	<?
	$cresult = mysql_query("SELECT CLASS_LIST.*, COUNT(*) FROM VALIDCLASS_LIST
					...
					WHERE VALIDCLASS_TEACHER=$usertag AND LAYER_ID IS NULL
					GROUP BY CLASS_LIST.CLASS_ID HAVING COUNT(*) > 1") or die(mysql_error());
