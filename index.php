...
<head>
	...
	<style type="text/css"><!--
		...
		#commentBox { margin-left: auto; margin-right: auto }
		#showCommentBox { text-align: center }
	--></style>
</head>
...
<div style="width: 210px" class="pagecolumn">
	...
	<? if($isvalidated) { ?>
		<h2 class="red"><a href="/mail/">My Mail</a></h2><div class="headed">
		...
		<p style="margin: 0px"><input onfocus="document.getElementById('mailcomposebox').style.display = 'block'; document.getElementById('mailcomposearrow').style.display = 'none';" style="width: 180px" type="text" name="xto" value="" size="55"><img src="/imgs/arrow-down.gif" onclick="document.getElementById('mailcomposebox').style.display = 'block'; document.getElementById('mailcomposearrow').style.display = 'none';" id="mailcomposearrow" style="vertical-align: middle" alt="(more)"></p>
	...
	<h2 class="red"><a href="/notepad/">My Notes</a></h2><div class="headed">
...
<div style="width: 210px" class="pagecolumn">
	...
	<h2 class="red"><a href="/calendar/">My Calendar</a></h2><div class="headed">
		<ul class="flat" style="margin: 0px">
		<?
...
<div style="width: 315px" class="pagecolumn">
	...
	<? if(false) { ?>
	<h2 class="gray">Notices</h2><div class="headed"><? include "blocks/$insideblock" ?></div>
	<? } ?>
</div>
...
<table>
<tr><td style="text-align: right; font-weight: bold">More Services</td><td><a href="news/">News</a>, <a href="map/">Map</a>, <a href="notepad/">Notepad</a>, <a href="classifieds/">Classifieds</a>, <a href="qa/">Q&amp;A Service</a></td></tr>
...
<? } else { ?>
	...
	<td valign="middle" style="width: 50%">
		...
		<div style="font-size: medium; letter-spacing: 1pt; font-weight: bold">Log In</div>
		<table style="margin-left: auto; margin-right: auto;">
			<tr><td>Username</td><td style="text-align: left"><input type="text" name="un" value=""></td></tr>
			<tr><td>Password</td><td style="text-align: left"><input type="password" name="pw"> <input type="hidden" name="job" value="login"><input type="submit" name="btn" value="Login"></td></tr>
		</table>
		</form>
		<? } else { ?>
		...
		<? } ?>
		<div style="margin: 0px; padding: 3px; background-color: #dddddd">Are you holding an <span style="font-weight: bold">Activation Code</span>?<br><a href="new-user.php" style="font-weight: bold">Create a new account</a> before you log in.</div>
		<table cellpadding="1" cellspacing="1" width="100%" style="border-bottom: 1px solid #999999; table-layout: fixed; font-size: medium; text-align: center"><tr><td><a href="/tour/">Tour</a></td><td><a href="/help/">FAQ</a></td><td style="font-weight: bold;"><a href="calendar/">Calendar</a></td><td style="font-weight: bold;"><a href="map/">Map</a></td></tr></table>
		</div>
		...
		<table width="100%" cellpadding="2" cellspacing="2"><tr><td class="yellowbox"><? include "blocks/$block" ?></td></tr></table>
	</td>
	</tr>
	</table>
