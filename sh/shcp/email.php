...
?>
<form action="email.php<?= $getstring ?>" enctype="multipart/form-data" name="mf" method="POST" style="margin: 0px">
<? $page->do_error(); ?>
...
?>
<form action="/edit-user.php?id=<?= $l['USER_ID'] ?>" name="mf" method="POST" target="_blank">
<h2><?= $afull ?></h2>
