<?
	define('DNAME','webscript.princeton.edu');
...
*/
//	define('MODULES', serialize(array('db','datetime','bits','email','form','news','spiffy','smarty','smtp','xml')) );
		define('MODULES', serialize(array('db','datetime','bits','email','form','news','spiffy','smtp','xml')) );
...
*/
	define('MODULE_DIR',"/public_html/mmwu/sh/page/");
	define('INCLUDE_DIR',"/public_html/mmwu/sh/inc/");
...
*/
	...
	define('DB_HOST',":/home/apache/mysql/data/mysql.sock");
	define('DB_USER',"mmwu");
	define('DB_PASSWORD',"h4dok3n9");

	define('DB_DATABASE',"mmwu");
